					...
					<div class="search-container">
						...
						<div id="search-bar">
							...
							<input class="form-search" id="search" type="text"
								placeholder="후기 검색" name ="keyword">
		...
		<nav aria-label="Page navigation example" id="pagination-nav">
		  <ul class="pagination">
		     <c:if test="${pagination.before}">
		      <li class="page-item">
				<form action="/review/listReview" method="get" id="move${pagination.start - 1}">
					<input type="hidden" name="pageSize" value="10">
		    ...
		    <c:forEach var="page" begin="${pagination.start}" end="${pagination.end}">
				<li class="page-item">
					<form action="/review/listReview" method="get" id="move${page}">
						<input type="hidden" name="pageSize" value="10">
						<input type="hidden" name="keyword" value="${pagination.keyword}">
			...
			<li class="page-item">
				<form action="/review/listReview" method="get" id="move${pagination.end + 1}">
					<input type="hidden" name="pageSize" value="10">
					<input type="hidden" name="keyword" value="${pagination.keyword}">
